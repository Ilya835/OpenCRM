...
class Boolean(QtWidgets.QGroupBox):
    """
    ...
    def __init__(self, name=module_name, formatString=None, isCheckable=False):
        ...
        self.setTitle(name)
        self.dataInput = QtWidgets.QCheckBox(self)
    ...
    def connectMethod(self, method):
        self.dataInput.checkStateChanged.connect(method)

    def getData(self):
        return self.dataInput.checkState()

    def setData(self, data):
        self.dataInput.setChecked(bool(data))

    def clearData(self):
        self.dataInput.setChecked(False)
